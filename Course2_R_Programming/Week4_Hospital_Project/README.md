# Hospital Quality Data Analysis
...
As part of the course, one is provided a [Hospital Quality Dataset](https://d396qusza40orc.cloudfront.net/rprog%2Fdata%2FProgAssignment3-data.zip) which contains the following files
...
Based on the provided data, one has perform the following tasks
...
The solutions are in the following files in this repo
