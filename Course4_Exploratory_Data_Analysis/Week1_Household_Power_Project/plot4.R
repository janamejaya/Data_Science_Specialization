...
plot_figure4 <- function(){
  ...
  with(alldata, plot(datetime, Global_active_power, type="l", xlab="", ylab="Global Active Power"))
  
  with(alldata, plot(datetime, Voltage, type="l", xlab="datetime", ylab="Voltage"))
  ...
  with(alldata, plot(datetime, Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power"), lwd=0.1)
  #with(alldata, {
  #  plot(datetime, Global_reactive_power, type="l",xlab="datatime", ylab="Global_reactive_power", lwd=0.1)
  #  points(datetime, Global_reactive_power, xlab="", ylab="", pch=16, cex=0.1)
  #})
  #with(alldata, plot(datetime, Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power"))
